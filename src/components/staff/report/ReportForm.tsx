      ...
      <DialogContent className="max-w-4xl max-h-screen overflow-y-auto bg-[#F9FAFB] p-6 rounded-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="col-span-1 md:col-span-2 flex gap-4 items-center">
            <Button
              variant="outline"
              className="bg-white hover:text-white text-sm w-full justify-between"
            >
              Select Date
        ...
        <div className="space-y-2 mb-4">
          ...
          {Array.from({ length: 4 }).map((_, idx) => (
            <div key={idx} className="grid grid-cols-4 gap-3">
              ...
              <Input
                placeholder="Macaroni & Cheese with Steamed Carrots"
                className="bg-white text-sm"
              />
              <Select>
                <SelectTrigger className="bg-white text-sm">
          ...
          <Button
            variant="text"
            className="text-[#FFA726] hover:bg-transparent text-sm"
          >
            ...
            <div key={idx} className="grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="not-participated">
                    Did not Participate
                  </SelectItem>
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="grid grid-cols-4 gap-3">
            <Input
              value="Math - Addition and Subtraction"
              className="bg-white text-sm col-span-1"
              readOnly
            />
