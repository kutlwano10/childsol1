...
const initialComments = [
    ...
    },
    {
      ...
      content: 'Thank you for the update! I\'m so happy to hear that Ayanda had a great day and enjoyed the activities. We appreciate all the care and support from the teachers. Looking forward to another wonderful day tomorrow!',
      timestamp: '2m ago',
    },
  ];
